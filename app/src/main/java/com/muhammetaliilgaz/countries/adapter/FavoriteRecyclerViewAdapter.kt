...
class FavoriteRecyclerViewAdapter(private val context:Context, private val countriesList: ArrayList<Data>, private val listener: Listener): RecyclerView.Adapter<FavoriteRecyclerViewAdapter.CardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_favorite_item,parent,false)
